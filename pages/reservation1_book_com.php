                ...
                <div class="p-3 bg-light border rounded shadow-sm">
                    ...
                    <div class="row">
                        <div class="col-2 text-end mt-3">
                            <h5 class="card-title"
                                style="font-size: 18px; font-weight: bold; text-transform: uppercase; color: #007468;"
                                ...
                                <div class="container mt-4">
                                    <form style="margin-top: -10px;">
                                        <div class="form-group"
                                            style="margin-bottom: 10px; margin-top: -10px; display: flex; align-items: center;">
                                            <label for="deviceName" class="font-weight-bold text-success"
                                                style="font-size: 16px; color: #007468; margin-right: 10px; white-space: nowrap;">ชื่ออุปกรณ์
                                                :</label>
                                            <input type="text" class="form-control" id="deviceName" value="เมาส์"
                                                readonly
                                                style="padding: 10px; font-size: 16px; flex-grow: 1; opacity: 0.6;">
                                        </div>

                                        <div class="form-group row" style="margin-bottom: 10px;">
                                            <div class="col-sm-6" style="padding-right: 5px;">
                                                <label for="purpose" class="font-weight-bold text-success"
                                                    style="font-size: 16px; color: #007468;">
                                                    เพื่อไปใช้งาน :</label>
                                            ...
                                            <div class="col-sm-6" style="padding-left: 5px;">
                                                <label for="location" class="font-weight-bold text-success"
                                                    style="font-size: 16px; color: #007468;">
                                        ...
                                        <div class="form-group row" style="margin-bottom: 10px;">
                                            <div class="col-sm-4" style="padding-right: 5px;">
                                                <label for="startDate" class="font-weight-bold text-success"
                                                    style="font-size: 16px; color: rgba(0, 116, 72, 0.6);">วันที่ยืม
                                                    :</label>
                                            ...
                                            <div class="col-sm-4" style="padding-right: 5px;">
                                                <label for="endDate" class="font-weight-bold text-success"
                                                    style="font-size: 16px; color: rgba(0, 116, 72, 0.6);">วันที่คืน
                                                    :</label>
                                            ...
                                            <div class="col-sm-4" style="padding-left: 5px;">
                                                <label for="timeReturn" class="font-weight-bold text-success"
                                                    style="font-size: 16px; color: rgba(0, 116, 72, 0.6);">เวลาคืน
                                                    :</label>
                                        ...
                                        <div class="form-group" style="text-align: center; margin-top: 25px;">
                                            <button type="button" class="btn btn-success" id="agreeButton"
                                                style="padding: 10px 20px; font-size: 14px;">ตกลง</button>
                                        </div>
                                    </form>
                                </div>
                                    ...
                                    <div class="modal-dialog modal-lg">
                                        <div class="modal-content"
                                            ...
                                            <div class="modal-header"
                                                style="background-color: #78C756; color: white; border-top-left-radius: 15px; border-top-right-radius: 15px; padding: 20px 30px;">
                                                <h5 class="modal-title" id="confirmationModalLabel"
                                                    style="font-size: 20px; font-weight: 600; letter-spacing: 1px;">
                                                    ข้อกำหนดและแนวปฏิบัติในการยืม-คืน พัสดุ/ครุภัณฑ์</h5>
                                            ...
                                            <div class="modal-body"
                                                ...
                                                <p>กรุณายอมรับข้อกำหนดและแนวปฏิบัติในการยืม-คืน พัสดุ/ครุภัณฑ์
                                                    ก่อนทำการยืมอุปกรณ์</p>
                                                <ul class="list-group">
                                                    <li class="list-group-item"
                                                        style="font-size: 14px; border: none; padding: 10px 15px;">
                                                        <strong>1. </strong>
                                                    ...
                                                    <li class="list-group-item"
                                                        ...
                                                        หรือชดใช้เป็นพัสดุครุณัฑ์ ประเภท ชนิด ขนาด ลักษณะ
                                            ...
                                            <div class="modal-footer">
                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal"
                                                    style="border-radius: 8px; font-size: 16px;">ปิด</button>
