            ...
            <div class="p-5 bg-light border rounded shadow-sm mt-5 mx-auto" style="width: 650px; margin-bottom: 60px;">
                ...
                <form action="../connect/bank/update.php" method="post" id="editForm">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" class="form-control mt-2" id="other_bank_name" name="other_bank_name"
                            placeholder="กรุณาระบุธนาคารอื่นๆ" style="display:none;">
                    </div>
                    ...
                    <!-- หมายเลขบัญชี -->
                    <div class="mb-4">
                        <label for="account_number" class="form-label">หมายเลขบัญชี <span
                                class="text-danger">*</span></label>
                        <input type="text" class="form-control" id="account_number" name="account_number"
                            value="<?php echo htmlspecialchars($account_Number); ?>" oninput="formatAccountNumber(this)"
                            required>
                    </div>
                    ...
                    <!-- ชื่อบัญชี -->
                    <div class="mb-4">
                        <label for="account_name" class="form-label">ชื่อบัญชี <span
                                class="text-danger">*</span></label>
                    ...
                    <!-- รายละเอียดบัญชี -->
                    <div class="mb-4">
                        <label for="account_detail" class="form-label">รายละเอียดเพิ่มเติม <span
                                class="text-danger">*</span></label>
                        <textarea class="form-control" id="account_detail" name="account_detail" rows="3"
                            required><?php echo htmlspecialchars($bank_Details); ?></textarea>
                    </div>
