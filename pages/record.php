                        ...
                        <?php if ($row['device_Con'] != 0): ?>
                            <li class="list-group-item d-flex justify-content-between align-items-center"
                                ...
                                <div>
                                    ...
                                    <div style="font-size: 12px; color: #6c757d;">
                                        สถานะ:
                                        <?= $row['device_Con'] == 2 ? 'ไม่อนุมัติ' : ($row['history_Status'] == '2' ? 'คืนแล้ว' : (isset($row['note_Other']) ? htmlspecialchars($row['note_Other']) : 'กำลังยืม')) ?>
                                    </div>
                                </div>
                                <span
                                    ...
                                    <?= ($row['device_Con'] == 2) ? 'ไม่อนุมัติ' : ($row['history_Status'] == 2 ? 'คืนแล้ว' : (isset($row['officer_Cotton_name']) ? htmlspecialchars($row['officer_Cotton_name']) : 'กำลังยืม')) ?>
                                </span>
                            </li>
                        <?php endif; ?>
                    <?php endwhile; ?>
