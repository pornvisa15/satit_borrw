    ...
    <div class="flex-grow-1 p-4">
        ...
        <div class="card shadow-sm border-0" style="margin-top: 49px;">
            ...
            <div class="p-5 bg-light border rounded shadow-sm mt-5 mx-auto" style="width: 650px; margin-bottom: 60px;">
                ...
                <form id="updateForm" action="../connect/equipment/update.php" method="post"
                    ...
                    <div class="mb-4">
                        <label for="officer_Cotton" class="form-label"
                            style="font-size: 16px; color: black;">ฝ่ายที่รับผิดชอบ:</label>
                        <select id="officer_Cotton" name="officer_Cotton" class="form-select">
                            <option value="1" <?php echo ($officer_Cotton == 1 ? 'selected' : ''); ?>>ฝ่ายคอมพิวเตอร์
                            </option>
                            <option value="2" <?php echo ($officer_Cotton == 2 ? 'selected' : ''); ?>>ฝ่ายวิทยาศาสตร์
                            </option>
                    ...
                    <div class="mb-4">
                        <label for="device_Other" class="form-label"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="hidden" name="device_Image_hidden"
                            value="<?php echo htmlspecialchars($device_Image); ?>">
                    </div>



                    <div class="mb-4">
                        <label for="device_Access" class="form-label"
                            style="font-size: 16px; color: black;">ใช้สำหรับ:</label>
                        <select id="device_Access" name="device_Access" class="form-select" required>
                            <option value="1" <?php echo ($device_Access == 1 ? 'selected' : ''); ?>>นักเรียนและบุคลากร
                            </option>
