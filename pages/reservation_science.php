...
<div class="row g-4 mt-5 justify-content-center">
    ...
    <div class="col-3">
        <div class="card h-100 shadow-sm d-flex flex-column">
            <div class="text-center mb-4">
                <!-- คลิกลิงก์ที่รูปภาพ -->
                <a href="#">
                    <img src="/satit_borrw/img/7.jpg" alt="Mouse Image" class="img-fluid" style="max-width: 150px;">
                </a>
            </div>
    ...
    <div class="col-3">
        <div class="card h-100 shadow-sm d-flex flex-column">
            <div class="text-center mb-4">
            <a href="#">
                    <img src="/satit_borrw/img/5.jpg" alt="Laptop Image" class="img-fluid" style="max-width: 150px;">
                </a>
            </div>
            <div class="card-body d-flex flex-column">
    ...
    <div class="col-3">
        <div class="card h-100 shadow-sm d-flex flex-column">
            <div class="text-center mb-4">
            <a href="#">
                    <img src="/satit_borrw/img/7.jpg" alt="Laptop Image" class="img-fluid" style="max-width: 150px;">
                </a>
            </div>
            <div class="card-body d-flex flex-column">
                <h6 class="card-title mb-auto">ชื่ออุปกรณ์ : ขวดปรับปริมาตร</h6>
    ...
    <div class="col-3">
        <div class="card h-100 shadow-sm d-flex flex-column">
            <div class="text-center mb-4">
            <a href="#">
                    <img src="/satit_borrw/img/5.jpg" alt="Mouse Image" class="img-fluid" style="max-width: 150px;">
                </a>
            </div>
            <div class="card-body d-flex flex-column">
                <h6 class="card-title mb-auto">ชื่ออุปกรณ์ : บีกเกอร์</h6>
